...
Stash lets you quickly save notes from your terminal. Whether you want to use the interactive editor, paste from your clipboard, pipe content from another command, or pass a string, Stash saves your text as a date stamped and titled markdown file in a directory you specify once at set up. Done't lose your focus trying to find the right spot to put a note or quick idea, organize your thoughts later after you've finished your work.
